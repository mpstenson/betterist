        ...
        <div class="bet-grid" id="content-container">
          <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            <?php if (has_post_thumbnail( $post->ID ) ): ?>
              ...
              <div class="bet-col-1-1 header-container" style="background-image: url('<?php echo $image[0]; ?>')" data-uk-parallax="{bg: '-400'}">
...
<?php endif; ?>
            ...
            <div class="bet-col-2-10"></div><div class="bet-col-6-10">
